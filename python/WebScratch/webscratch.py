...
driver = webdriver.Chrome("C:/DevSai/pydriver/chromedriver.exe")
driver.get("https://kinepolis.es/")
...
time.sleep(3)
# select city
button = driver.find_element_by_xpath('/html/body/div[2]/div/div[1]/div/div/a[4]')
button.click()
